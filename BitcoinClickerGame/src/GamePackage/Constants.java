...
class Constants {
	...
	//==== Item Info ====
		...
		public static final String instructions				= 
				...
				+ "     - Health Pack  : Heal 10 health. Price will double each purchase\n"
				+ "\n"
				+ " Hover your mouse over each item on the screen to the description in-game\n"
				+ "\n"
				+ "> Health\n"
				+ " Each player has 100 health to begin with. Once you hit 0, you are gone\n"
				+ " Once you are eliminated from the game, you can no longer do any actions\n"
				+ "	You can only spectate the remainder of the game and participate in the\n"
				+ " chat.\n"
				+ "> Player information\n"
				...
				+ "\n"
				+ "> Chat\n"
				+ " On the right hand side is the chat. Feel free to talk to your opponents and\n"
				+ " make negotiations. If you would like to talk to a player in private,\n"
				+ " use the whisper functionality by typing:\n"
				+ "        /Whisper:<player name> <message>\n"
				+ " eg.  /Whisper:player1 Let's team up against player 2!\n"
				+ "\n"
				+ "> Statistics\n"
				+ " At the end of each game, a statistics window will pop up. The displayed\n"
				+ " statistics are stored in accordance with your alias, therefore if you would\n"
